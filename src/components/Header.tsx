...
export const Header = () => {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-20 flex items-center justify-between bg-slate-800 px-4 py-3 sm:px-6 md:py-4 lg:px-8">
      <Link href="/">
        <Image src="/img/favicon.ico" alt="Ashiqul" width="30" height="20" />
      </Link>
